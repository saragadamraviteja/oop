/**
 * This class maintains the contacts of your friends / relations
 * / wellwishers et.
 *
...
class ContactsManager {
    ...
    public ContactsManager() {
        final int x = 500;
        myFriends = new Contact[x];
        friendsCount = 0;
    }
    /**
     * The addContact method takes in a parameter of type contact
     * object and
    ...
    /**
     * This method search for the contact based on the name
     * of your friend and gives the
    ...
    /**
     * This method search for the contact based on the email of
     * your friend
     * and gives the first occurance of the contact in your
     * friends list.
     * @param email the email of the contact to be searched in
     * the friends list.
     * @return the contact of the friend, null otherwise.
     */
